...
class SmartcarMethodChannel extends SmartcarPlatformInterface {
  ...
  final MethodChannel _channel =
      const MethodChannel('brinnixs/flutter_smartcar_auth');

  /// The event channel used to receive changes from the native platform.
  final EventChannel _eventChannel =
      const EventChannel('brinnixs/flutter_smartcar_auth/events');
  ...
  @override
  Future<void> launchAuthFlow(
      {AuthUrlBuilder authUrlBuilder = const AuthUrlBuilder()}) async {
